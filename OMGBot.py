...
#Date and investment
ethinvestment=pd.read_sql("""SELECT sum(InvestmentETH) as InvestmentETH FROM thememes6529.investors""",sql_engine)
...
bidcol.write(returnsbid)
askcol.write(returnsask)
